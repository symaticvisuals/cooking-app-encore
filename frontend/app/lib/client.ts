// Code generated by the Encore v1.43.12 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-cooking-app-7z4i.encr.app`
}
...
/**
 * Client is an API client for the cooking-app-7z4i Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "cooking-app-7z4i-Generated-TS-Client (Encore/v1.43.12)";
        }
